// Lightweight inline SVG icons (stroke-based). No icon library dependency.
...
export function Palette(props: IconProps) {
  return (
    <svg {...base(props)}>
      <path d="M12 22a10 10 0 1 1 10-10c0 2.2-1.8 3-3.5 3H16a2 2 0 0 0-1.5 3.3c.5.6.2 1.7-1 1.7z" />
...
export function Key(props: IconProps) {
  return (
    <svg {...base(props)}>
      ...
      <path d="m10.7 12.3 8.8-8.8M17 5.5l2.5 2.5M14 8.5l2 2" />
    </svg>
  );
}
...
export function Zap(props: IconProps) {
  return (
    <svg {...base(props)}>
      <path d="M13 2 4.09 12.35a.5.5 0 0 0 .38.82H11l-1 8 8.91-10.35a.5.5 0 0 0-.38-.82H13z" />
    </svg>
  );
}
